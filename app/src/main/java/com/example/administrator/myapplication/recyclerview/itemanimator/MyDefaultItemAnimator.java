 ...
 */
package com.example.administrator.myapplication.recyclerview.itemanimator;
...
public class MyDefaultItemAnimator extends SimpleItemAnimator {
    ...
    void animateMoveImpl(final ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        System.out.println(String.format("fromX=%d,fromY=%d,toX=%d,toY=%d",fromX,fromY,toX,toY));
        if (deltaX != 0) {
     ...
     * then MyDefaultItemAnimator will call {@link #animateMove(ViewHolder, int, int, int, int)} and
