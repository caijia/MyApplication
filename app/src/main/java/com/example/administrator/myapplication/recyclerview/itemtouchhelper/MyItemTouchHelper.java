 ...
 * {@link MyItemTouchHelper.Callback} class or implementing {@link MyItemTouchHelper.ViewDropHandler}
 * interface in your LayoutManager.
 * <p>
 * By default, MyItemTouchHelper moves the items' translateX/Y properties to reposition them. On
 * platforms older than Honeycomb, MyItemTouchHelper uses canvas translations and View's visibility
...
public class MyItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    /**
     * MyItemTouchHelper is in idle state. At this state, either there is no related motion event by
    ...
    static final String TAG = "MyItemTouchHelper";
    ...
    /**
     * Set when MyItemTouchHelper is assigned to a RecyclerView.
     */
    ...
    /**
     * Developer callback which controls the behavior of MyItemTouchHelper.
     */
    Callback mCallback;
    ...
    /**
     * Creates an MyItemTouchHelper that will work with the given Callback.
     * <p>
     * You can attach MyItemTouchHelper to a RecyclerView via
    ...
    /**
     * Attaches the MyItemTouchHelper to the provided RecyclerView. If TouchHelper is already
     * attached to a RecyclerView, it will first detach from the previous one. You can call this
     * method with {@code null} to detach it from the current RecyclerView.
     *
     * @param recyclerView The RecyclerView instance to which you want to add this helper or
     *                     {@code null} if you want to remove MyItemTouchHelper from the current
     *                     RecyclerView.
     */
        ...
        mRecyclerView.post(new Runnable() {
            ...
            public void run() {
                if (mRecyclerView != null && mRecyclerView.isAttachedToWindow() &&
                    ...
                    // not to call onSwiped because MyDefaultItemAnimator is not good at merging
    ...
    boolean scrollIfNecessary() {
        ...
        if (lm.canScrollVertically()) {
            Log.d("wrap", "tempRect l= " + mTmpRect.left + "--tempRect r=" + mTmpRect.right);
            Log.d("wrap", "tempRect t= " + mTmpRect.top + "--tempRect b=" + mTmpRect.bottom);
    ...
    /**
     * Starts dragging the provided ViewHolder. By default, MyItemTouchHelper starts a drag when a
     * View is long pressed. You can disable that behavior by overriding
     * {@link MyItemTouchHelper.Callback#isLongPressDragEnabled()}.
     * <p>
     ...
     * MyItemTouchHelper
     * is attached.</li>
     * <li>{@link MyItemTouchHelper.Callback} must have dragging enabled.</li>
     * <li>There must be a previous touch event that was reported to the MyItemTouchHelper
    ...
    public void startDrag(ViewHolder viewHolder) {
        ...
        if (viewHolder.itemView.getParent() != mRecyclerView) {
            Log.e(TAG, "Start drag has been called with a view holder which is not a child of "
                    + "the RecyclerView which is controlled by this MyItemTouchHelper.");
            return;
        }
        obtainVelocityTracker();
        mDx = mDy = 0f;
    ...
    /**
     * Starts swiping the provided ViewHolder. By default, MyItemTouchHelper starts swiping a View
     * when user swipes their finger (or mouse pointer) over the View. You can disable this
     * behavior
     * by overriding {@link MyItemTouchHelper.Callback}
     * <p>
     * For this method to work:
     * <ul>
     * <li>The provided ViewHolder must be a child of the RecyclerView to which this
     * MyItemTouchHelper is attached.</li>
     * <li>{@link MyItemTouchHelper.Callback} must have swiping enabled.</li>
     * <li>There must be a previous touch event that was reported to the MyItemTouchHelper
     * through RecyclerView's ItemTouchListener mechanism. As long as no other ItemTouchListener
     * grabs previous events, this should work as expected.</li>
     * </ul>
    ...
    public void startSwipe(ViewHolder viewHolder) {
        ...
        if (viewHolder.itemView.getParent() != mRecyclerView) {
            Log.e(TAG, "Start swipe has been called with a view holder which is not a child of "
                    + "the RecyclerView controlled by this MyItemTouchHelper.");
            return;
        }
        obtainVelocityTracker();
        mDx = mDy = 0f;
    ...
    /**
     * This class is the contract between MyItemTouchHelper and your application. It lets you control
     ...
     * {@link SimpleCallback}.
     * <p>
     * If user drags an item, MyItemTouchHelper will call
     ...
     * custom drop target.
     * <p>
     * When a View is swiped, MyItemTouchHelper animates it until it goes out of bounds, then calls
    ...
    public abstract static class Callback {
         ...
         * swiping.
         *
         * @param recyclerView The RecyclerView to which MyItemTouchHelper is attached.
         ...
         *
         * @param recyclerView The RecyclerView to which MyItemTouchHelper is attached to.
        ...
        /**
         * Called when MyItemTouchHelper wants to move the dragged item from its old position to
         * the new position.
         * <p>
         * If this method returns true, MyItemTouchHelper assumes {@code viewHolder} has been moved
        ...
        /**
         * When finding views under a dragged view, by default, MyItemTouchHelper searches for views
         ...
         * dragged. After a view is moved this amount, MyItemTouchHelper starts checking for Views
         ...
         * Keep in mind that MyItemTouchHelper also checks the perpendicular velocity and makes sure
        ...
        /**
         * Defines the maximum velocity MyItemTouchHelper will ever calculate for pointer movements.
         * <p>
         * To consider a movement as swipe, MyItemTouchHelper requires it to be larger than the
         ...
         *
         * @param defaultValue The default value(in pixels per second) used by the MyItemTouchHelper.
        ...
        /**
         * Called by MyItemTouchHelper to select a drop target from the list of ViewHolders that
         ...
         * <p>
         * MyItemTouchHelper will keep a reference to the View until it is detached from
         * RecyclerView.
         * As soon as it is detached, MyItemTouchHelper will call
        ...
        /**
         * Called when the ViewHolder swiped or dragged by the MyItemTouchHelper is changed.
         * <p/>
         ...
         * <p>
         * MyItemTouchHelper does not create an extra Bitmap or View while dragging, instead, it
         ...
         *
         * @param recyclerView The RecyclerView controlled by the MyItemTouchHelper.
        ...
        void onDraw(Canvas c, RecyclerView parent, ViewHolder selected,
                List<MyItemTouchHelper.RecoverAnimation> recoverAnimationList,
                int actionState, float dX, float dY) {
            final int recoverAnimSize = recoverAnimationList.size();
            for (int i = 0; i < recoverAnimSize; i++) {
                final MyItemTouchHelper.RecoverAnimation anim = recoverAnimationList.get(i);
                anim.update();
        ...
        /**
         * Called by the MyItemTouchHelper when the user interaction with an element is over and it
         ...
         *
         * @param recyclerView The RecyclerView which is controlled by the MyItemTouchHelper.
        ...
        /**
         * Called by MyItemTouchHelper on RecyclerView's onDraw callback.
         * <p>
         ...
         * <code>dY</code>.
         * MyItemTouchHelper also takes care of drawing the child after other children if it is being
        ...
        /**
         * Called by the MyItemTouchHelper when user action finished on a ViewHolder and now the View
         ...
         *
         * @param recyclerView  The RecyclerView to which the MyItemTouchHelper is attached to.
        ...
        /**
         * Called by the MyItemTouchHelper when user is dragging a view out of bounds.
         * <p>
         ...
         *
         * @param recyclerView        The RecyclerView instance to which MyItemTouchHelper is
         *                            attached to.
     ...
     *
     * <pre>
     * MyItemTouchHelper mIth = new MyItemTouchHelper(
     *     new MyItemTouchHelper.SimpleCallback(MyItemTouchHelper.UP | MyItemTouchHelper.DOWN,
